...
class Post(models.Model):
    ...
    username = models.TextField(blank=True) #username of the author of the post
    ...
    image = models.ImageField(blank=True, null=True, upload_to='tweetspic') #image of the post
...
class Comment(models.Model):
    ...
    created = models.DateTimeField(auto_now_add=True) #date and time of the comment
